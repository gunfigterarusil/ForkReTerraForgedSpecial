package rayman.rtfs.world.worldgen.noise.module;
...
public record Cache2d(Noise noise, ThreadLocal<Cached> cache) implements Noise {
	...
	public static class Cached implements Noise {
		...
		public Codec<Cached> codec() {
			throw new UnsupportedOperationException("Cache2d.Cached is a runtime-only Noise and cannot be serialized");
		}
	}
}
