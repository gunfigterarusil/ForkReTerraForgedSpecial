...
import rayman.rtfs.data.worldgen.preset.FilterSettings;
import rayman.rtfs.world.worldgen.densityfunction.tile.Tile;
import rayman.rtfs.world.worldgen.densityfunction.tile.filter.BeachDetect;
import rayman.rtfs.world.worldgen.densityfunction.tile.filter.Erosion;
import rayman.rtfs.world.worldgen.densityfunction.tile.filter.Filterable;
import rayman.rtfs.world.worldgen.densityfunction.tile.filter.NoiseCorrection;
import rayman.rtfs.world.worldgen.densityfunction.tile.filter.Smoothing;
import rayman.rtfs.world.worldgen.densityfunction.tile.filter.Steepness;
