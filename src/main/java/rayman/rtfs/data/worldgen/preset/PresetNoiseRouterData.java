...
public class PresetNoiseRouterData {
	...
	CaveSettings caveSettings = preset.caves();
        ...
        DensityFunction offset = rayman.rtfs.mixin.MixinNoiseRouterData.invokeRegisterAndWrap(ctx, rayman.rtfs.mixin.MixinNoiseRouterData.getOFFSET(), DensityFunctions.add(DensityFunctions.constant(NoiseRouterData.GLOBAL_OFFSET - 0.5F), DensityFunctions.mul(RTFDensityFunctions.clampToNearestUnit(height, properties.terrainScaler()), DensityFunctions.constant(2.0D))));
