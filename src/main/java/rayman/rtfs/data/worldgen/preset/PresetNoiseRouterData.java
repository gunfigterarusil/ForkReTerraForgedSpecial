...
public class PresetNoiseRouterData {
	...
	CaveSettings caveSettings = preset.caves();
        ...
        DensityFunction offset = rayman.rtfs.mixin.MixinNoiseRouterData.invokeRegisterAndWrap(ctx, rayman.rtfs.mixin.MixinNoiseRouterData.getOFFSET(), DensityFunctions.add(DensityFunctions.constant(rayman.rtfs.mixin.MixinNoiseRouterData.getGLOBAL_OFFSET() - 0.5F), DensityFunctions.mul(RTFDensityFunctions.clampToNearestUnit(height, properties.terrainScaler()), DensityFunctions.constant(2.0D))));
...
//        DensityFunction entrances = DensityFunctions.min(slopedCheese, DensityFunctions.mul(DensityFunctions.constant(5.0), rayman.rtfs.mixin.MixinNoiseRouterData.invokeGetFunction(densityFunctions, rayman.rtfs.mixin.MixinNoiseRouterData.getENTRANCES())));
//        DensityFunction slopedCheeseCaves = DensityFunctions.rangeChoice(slopedCheese, -1000000.0, 1.5625, entrances, rayman.rtfs.mixin.MixinNoiseRouterData.invokeUnderground(densityFunctions, noiseParams, slopedCheese));
//        DensityFunction finalDensity = DensityFunctions.min(rayman.rtfs.mixin.MixinNoiseRouterData.invokePostProcess(slideOverworld(slopedCheeseCaves, -worldDepth)), rayman.rtfs.mixin.MixinNoiseRouterData.invokeGetFunction(densityFunctions, rayman.rtfs.mixin.MixinNoiseRouterData.getNOODLE()));
...
//
        ...
        return new NoiseRouter(aquiferBarrier, aquiferFluidLevelFloodedness, aquiferFluidLevelSpread, aquiferLava, temperature, vegetation, rayman.rtfs.mixin.MixinNoiseRouterData.invokeGetFunction(densityFunctions, rayman.rtfs.mixin.MixinNoiseRouterData.getCONTINENTS()), rayman.rtfs.mixin.MixinNoiseRouterData.invokeGetFunction(densityFunctions, rayman.rtfs.mixin.MixinNoiseRouterData.getEROSION()), DensityFunctions.add(depth, DensityFunctions.constant(-0.275D)), rayman.rtfs.mixin.MixinNoiseRouterData.invokeGetFunction(densityFunctions, rayman.rtfs.mixin.MixinNoiseRouterData.getRIDGES()), slideOverworld(DensityFunctions.add(initialDensity, DensityFunctions.constant(UNIT * -90)).clamp(-64.0, 64.0), -worldDepth), finalDensity, oreVeininess, oreVein, oreGap);
	}
