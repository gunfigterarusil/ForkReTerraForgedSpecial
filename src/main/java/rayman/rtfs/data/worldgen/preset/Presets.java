...
import rayman.rtfs.data.worldgen.preset.ClimateSettings.BiomeNoise;
import rayman.rtfs.data.worldgen.preset.ClimateSettings.BiomeShape;
import rayman.rtfs.data.worldgen.preset.ClimateSettings.RangeValue;
import rayman.rtfs.data.worldgen.preset.FilterSettings.Erosion;
import rayman.rtfs.data.worldgen.preset.FilterSettings.Smoothing;
import rayman.rtfs.data.worldgen.preset.RiverSettings.Lake;
import rayman.rtfs.data.worldgen.preset.RiverSettings.River;
import rayman.rtfs.data.worldgen.preset.RiverSettings.Wetland;
import rayman.rtfs.data.worldgen.preset.TerrainSettings.General;
import rayman.rtfs.data.worldgen.preset.TerrainSettings.Terrain;
import rayman.rtfs.data.worldgen.preset.WorldSettings.Continent;
import rayman.rtfs.data.worldgen.preset.WorldSettings.ControlPoints;
import rayman.rtfs.data.worldgen.preset.WorldSettings.Properties;
...
public class Presets {
	...
	//TODO tune this preset for 1.18+ generation
	public static Preset makeLegacy1_18() {
		return makeLegacyDefault();
	}
}
