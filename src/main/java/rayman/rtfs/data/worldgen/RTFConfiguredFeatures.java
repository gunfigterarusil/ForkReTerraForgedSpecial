...
import rayman.rtfs.world.worldgen.feature.BushFeature;
import rayman.rtfs.world.worldgen.feature.DecorateSnowFeature;
import rayman.rtfs.world.worldgen.feature.ErodeFeature;
import rayman.rtfs.world.worldgen.feature.RTFFeatures;
import rayman.rtfs.world.worldgen.feature.SwampSurfaceFeature;
import rayman.rtfs.world.worldgen.feature.chance.ChanceFeature;
import rayman.rtfs.world.worldgen.feature.chance.ChanceModifier;
import rayman.rtfs.world.worldgen.feature.template.TemplateFeature;
import rayman.rtfs.world.worldgen.feature.template.decorator.DecoratorConfig;
import rayman.rtfs.world.worldgen.feature.template.decorator.TemplateDecorator;
import rayman.rtfs.world.worldgen.feature.template.decorator.TreeContext;
import rayman.rtfs.world.worldgen.feature.template.paste.PasteConfig;
...
public class RTFConfiguredFeatures {
	...
	public static void bootstrap(Preset preset, BootstapContext<ConfiguredFeature<?, ?>> ctx) {
		...
		if(miscellaneous.erosionDecorator) {
			FeatureUtils.register(ctx, ERODE, RTFFeatures.ERODE, ErodeFeature.Config.makeDefault());
		}

		if(miscellaneous.naturalSnowDecorator || miscellaneous.smoothLayerDecorator) {
			FeatureUtils.register(ctx, DECORATE_SNOW, RTFFeatures.DECORATE_SNOW, new DecorateSnowFeature.Config(miscellaneous.naturalSnowDecorator, miscellaneous.smoothLayerDecorator, ErodeFeature.Config.makeDefault()));
		}
